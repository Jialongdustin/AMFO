...
import csv
from data.librispeech import get_melspectrum
import h5py
import torch
import random
...
class librispeech_val():
    def __init__(self, args, c_way=5, k_shot=5, val=False):
        ...
        self.root = settings.librispeech_DIR
        self.IndexDir = os.path.join(settings.librispeech_Index_DIR, args.seed, str(args.ways))
        self.count = 0
        self.val = val
        self.args = args
